...
<ul>
  ...
  <li>All fault-detection thresholds in this project were derived from a single month (August 2022) at a single location (São Paulo, Brazil — a subtropical climate, with August falling in the Brazilian winter). They have not been validated against other seasons or installation sites, and may need re-calibration if applied elsewhere.</li>
</ul>
<p>
